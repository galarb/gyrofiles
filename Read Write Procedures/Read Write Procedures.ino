...
//String getData = "GET /channels/"+ ChannelID +"/fields/1.json?api_key="+API+"&results=1";
...
AT+CWMODE=3					
AT+CWJAP="arbs","lafamilia"							//	SSID	and	password	of	router
AT+CIFSR
AT+CIPSTART="TCP","api.thingspeak.com",80 - NOT WORKING
AT+CIPSEND=4
test
_______________________________________
TCP over dedicated channel
AT+CIPMUX=1
...
GET /update?api_key=VDEDADL7JFCVJFVR&field1=50
GET /update?api_key=VDEDADL7JFCVJFVR&field1=50
/update?api_key=VDEDADL7JFCVJFVR&field1=40
-------------_____________--------------------
...
AT+CIFSR
AT+CIPMUX=1
AT+CIPSTART=4,"UDP","api.thingspeak.com",80,1112,0 // channel 4
AT+CIPSEND=4,7
UDPtest
AT+CIPSEND=4,42
GET /update?api_key=VDEDADL7JFCVJFVR&field1=30
AT+CIPCLOSE=4
_____________________________________________
UDP (remote IP and port can be changed)
AT+CWMODE=3					
AT+CWJAP="arbs","lafamilia"							//	SSID	and	password	of	router
AT+CIFSR
AT+CIPMUX=1
AT+CIPSTART="UDP","api.thingspeak.com",80,1112,2 // channel 2
AT+CIPSEND=7
UDPtest
AT+CIPSEND=42
GET /update?api_key=VDEDADL7JFCVJFVR&field1=30
...
UART-WiFi Passthrough Mode - TCP
AT+CWMODE=3
AT+CWJAP="arbs","lafamilia"							//	SSID	and	password	of	router
AT+CIFSR
AT+CIPMUX=0
AT+CIPSTART="TCP","api.thingspeak.com",80
AT+CIPMODE=1 // enable UART passthrough mode

AT+CIPSEND		//From	now	on,	data	received	from	UART	will	be	transmitted	to	the	server	automatically.
GET /update?api_key=VDEDADL7JFCVJFVR&field1=80 /+++to stop sending
AT+CIPMODE=0 // disablea UART passthrough mode

AT+CIPCLOSE
_________________________________
UART-WiFi Passthrough Mode - UDP
AT+CWMODE=3
AT+CWJAP="arbs","lafamilia"							//	SSID	and	password	of	router
AT+CIFSR
AT+CIPSTART="UDP","api.thingspeak.com",80,2233,0
AT+CIPMODE=1 // enable UART passthrough mode

AT+CIPSEND		//From	now	on,	data	received	from	UART	will	be	transmitted	to	the	server	automatically.
GET /update?api_key=VDEDADL7JFCVJFVR&field1=30 /+++to stop sending
AT+CIPMODE=0 // disablea UART passthrough mode
...
case 0: sendCommand("AT",5,"OK");break;
case 1: sendCommand("AT+CWMODE=3",10,"OK");break;
case 2: sendCommand("AT+CIPMUX=1",5,"OK"); break;
case 3: sendCommand("AT+CIPSTART=\"""+ PROTOCOL +\""",\"""+ HOST +\""+ '80',15,"OK"); break; // connection id=0 

case 4: sendCommand("AT+CIPSEND=0," +String(setData.length()+4),4,">"); break; // sending to id=0, length of message
case 5: esp8266.println(setData);delay(1500);countTrueCommand++; break;
