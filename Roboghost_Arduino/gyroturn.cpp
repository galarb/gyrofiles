...
//main method. set the timer for best performance
...
double gyroturn::PIDcalc(double inp, int sp){
   ...
   cumError += error * elapsedTime/10000;              // compute integral, get it in sec
...
void gyroturn::lcdershow( int s, int e, int g){
  lcd.clear();
  lcd.setCursor(0, 0);
